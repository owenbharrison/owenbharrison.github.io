...
// include: C:\Users\owenb\AppData\Local\Temp\tmpr6zryfc_.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'C:/Users/owenb/Documents/vsc-workspace/simsAndGames/emscripten_build/sokol_testing/sokol.data';
...
Module['FS_createPath']("/assets/img", "font", true, true);
Module['FS_createPath']("/assets/img", "skybox", true, true);
Module['FS_createPath']("/assets", "models", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_C:/Users/owenb/Documents/vsc-workspace/simsAndGames/emscripten_build/sokol_testing/sokol.data');

      };
      Module['addRunDependency']('datafile_C:/Users/owenb/Documents/vsc-workspace/simsAndGames/emscripten_build/sokol_testing/sokol.data');
...
// end include: C:\Users\owenb\AppData\Local\Temp\tmpr6zryfc_.js
// include: C:\Users\owenb\AppData\Local\Temp\tmpo6faigti.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\owenb\AppData\Local\Temp\tmpo6faigti.js
// include: C:\Users\owenb\AppData\Local\Temp\tmpcszfdcvv.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\owenb\AppData\Local\Temp\tmpcszfdcvv.js
